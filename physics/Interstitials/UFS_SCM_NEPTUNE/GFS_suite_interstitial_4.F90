...
!!
    subroutine GFS_suite_interstitial_4_run (im, levs, ltaerosol, tracers_total, ntrac, ntcw, ntiw, ntclamt, &
      ...
      imp_physics_tempo, imp_physics_nssl, nssl_invertccn, nssl_ccn_on,                                                  &
      ...
      use module_mp_thompson_utils, only: &
      ...
      integer,              intent(in   )                   :: im, levs, tracers_total, ntrac, ntcw, ntiw, ntclamt, ntrw, &
        ...
        imp_physics_tempo, imp_physics_zhao_carr, imp_physics_zhao_carr_pdf, imp_physics_nssl
